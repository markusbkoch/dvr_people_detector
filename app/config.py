...
def load_settings(secrets_path: str = ".secrets") -> Settings:
    ...
    return Settings(
        ...
        rtsp_detection_fps=float(_get_env("RTSP_DETECTION_FPS", file_values, "12.0")),
        ...
        confidence_threshold=float(_get_env("MIN_PERSON_CONFIDENCE_FOR_ALERT", file_values, "0.5")),
        low_conf_log_min_confidence=float(_get_env("MIN_PERSON_CONFIDENCE_FOR_LOW_CONF_REVIEW", file_values, "0.15")),
        low_conf_review_cooldown_seconds=float(low_conf_review_cooldown_seconds),
        person_min_box_area_px=int(_get_env("PERSON_MIN_BOX_AREA_PX", file_values, "1200")),
        person_min_movement_px=float(_get_env("PERSON_MIN_MOVEMENT_PX", file_values, "5")),
        ...
        capture_mode=_get_env("CAPTURE_MODE", file_values, "rtsp").lower(),
