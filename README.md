...
To inspect and label snapshots visually in a browser:

```bash
python scripts/face_gallery.py --db-path data/faces.db --snapshot-dir data/snapshots --host 127.0.0.1 --port 8765
```
